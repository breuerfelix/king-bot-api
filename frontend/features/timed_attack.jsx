...
export default class SendTimedAttack extends Component {
  ...
  attackTarget = async e => {
	...
	render() {
		const { wait_time, all_villages, village_name, target_x, target_y, target_player_name, target_village_name, target_tribeId, target_distance } = this.state;
    ...
    const row_style = {
		...
		return (
            ...
            <button className='button is-radiusless' style='margin-right: 1rem' onClick={this.attackTarget}>
              add farm
            </button>
